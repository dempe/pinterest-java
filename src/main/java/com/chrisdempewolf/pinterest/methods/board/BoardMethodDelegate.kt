...
class BoardMethodDelegate(private val accessToken: String) {
    ...
    fun getBoard(boardName: String): BoardResponse {
        try {
            return Gson().fromJson(IOUtils.toString(buildBoardUri(accessToken, boardName, null)), BoardResponse::class.java)
    ...
    fun getBoard(boardName: String, boardFields: BoardFields): BoardResponse {
        try {
            return Gson().fromJson(IOUtils.toString(buildBoardUri(accessToken, boardName, boardFields.build())), BoardResponse::class.java)
        } catch (e: URISyntaxException) {
            throw PinterestException(e.message, e)
        } catch (e: IOException) {
            throw PinterestException(e.message, e)
    ...
    val myBoards: Boards
        get() {
            try {
                return Gson().fromJson(IOUtils.toString(buildMyBoardUri(accessToken, null)), Boards::class.java)
            } catch (e: URISyntaxException) {
                throw PinterestException(e.message, e)
            } catch (e: IOException) {
                throw PinterestException(e.message, e)
    ...
    fun getMyBoards(boardFields: BoardFields): Boards {
        try {
            return Gson().fromJson(IOUtils.toString(buildMyBoardUri(accessToken, boardFields.build())), Boards::class.java)
        } catch (e: URISyntaxException) {
            throw PinterestException(e.message, e)
        } catch (e: IOException) {
            throw PinterestException(e.message, e)
    ...
    fun getNextPageOfBoards(page: BoardPage?): Boards? {
        ...
        try {
            return Gson().fromJson(IOUtils.toString(URI(page.next)), Boards::class.java)
        } catch (e: URISyntaxException) {
            throw PinterestException(e.message, e)
        } catch (e: IOException) {
            throw PinterestException(e.message, e)
